...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/14 12:24:58 by mmakhlou          #+#    #+#             */
/*   Updated: 2024/06/14 12:31:05 by mmakhlou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

//helper function to check if the character 
//is one of the characters wish to trim
